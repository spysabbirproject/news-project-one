...
class FrontendController extends Controller
{
    ...
    {
        $category = Category::where('status', 'Active')->where('category_slug', $slug)->first();
        $default_setting = Default_setting::first();
        $tags = Tag::where('status', 'Active')->get();
        $all_news = News::where('status', 'Active')->where('news_category_id', $category->id)->paginate(12);
        $tranding_news = News::where('status', 'Active')->orderBy('news_view', 'desc')->get();
        $advertisements = Advertisement::where('status', 'Active')->get();
        $categories = Category::where('status', 'Active')->get();
    ...
    {
        $tag = Tag::where('status', 'Active')->where('tag_slug', $slug)->first();
        $default_setting = Default_setting::first();
        $tags = Tag::where('status', 'Active')->get();

        $news_id = DB::table('news_tag')->where('tag_id', $tag->id)->groupBy('news_id')->select('news_id')->paginate(12);
    ...
    {
        News::where('news_slug', $slug)->increment('news_view');
        $news_details = News::where('news_slug', $slug)->first();
        $default_setting = Default_setting::first();
        $tags = Tag::where('status', 'Active')->get();
        $all_news = News::where('status', 'Active')->get();
        $tranding_news = News::where('status', 'Active')->orderBy('news_view', 'desc')->get();
