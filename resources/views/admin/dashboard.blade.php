...
@endif
@php
    $reporter_wise_news = App\Models\News::where('created_by', Auth::guard('admin')->user()->id)->get();
@endphp
<div class="row">
        ...
        <div class="d-flex align-items-end row">
          <div class="col-sm-7">
            <div class="card-body">
              ...
              <p class="mb-4"> You have done <span class="fw-bold">{{ $reporter_wise_news->count() }}</span> more news. Check your all news.</p>
    ...
    <div class="col-lg-4 col-md-4 order-1">
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Total News ({{ $all_news->count() }})</h4>
            ...
            <div class="col-3 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-success fw-semibold">All User: {{ $all_user->count() }}</small>
                    </div>
                </div>
            </div>
            <div class="col-3 mb-4">
                <div class="card">
                    ...
                    <small class="text-success fw-semibold">All Administrator: {{ $all_administrator->count() }}</small>
                    </div>
                </div>
            </div>
            <div class="col-3 mb-4">
              ...
              <div class="col-3 mb-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h3 class="card-title mb-2">{{ $tags->count() }}</h3>
                  </div>
                </div>
              </div>
        </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="mb-2">{{ $categories->count() }}</h2>
          </div>
          <ul class="p-0 m-0">
