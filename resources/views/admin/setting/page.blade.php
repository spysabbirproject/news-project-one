                                ...
                                <div class="modal-body">
                                    <form action="#" method="POST" id="create_form">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <span class="text-danger error-text page_name_error"></span>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Page Description</label>
                                            <textarea name="page_description" class="form-control page_description_style" placeholder="Enter page description"></textarea>
                                            <span class="text-danger error-text page_description_error"></span>
                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="POST" id="edit_form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <span class="text-danger error-text update_page_name_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Page Description</label>
                                                    <textarea name="page_description" class="form-control " id="page_description"></textarea>
                                                    <span class="text-danger error-text update_page_description_error"></span>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.page_description_style').summernote({
        ...
        $(document).on('click', '.editBtn', function(e){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#page_description").val(response.page_description);
