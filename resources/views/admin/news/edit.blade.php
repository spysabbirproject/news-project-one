                ...
                <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="news_headline" value="{{ $news->news_headline }}"/>
                            @error('news_headline')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" name="news_quote" >{{ $news->news_quote }}</textarea>
                            @error('news_quote')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" name="news_details" id="news_details">{{ $news->news_details }}</textarea>
                            @error('news_details')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
