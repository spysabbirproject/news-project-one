                ...
                <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="news_headline" value="{{ old('news_headline') }}" placeholder="Type news headline"/>
                            @error('news_headline')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <label class="form-label">News Quote</label>
                            <textarea class="form-control" name="news_quote" placeholder="Type news quote">{{ old('news_quote') }}</textarea>
                            @error('news_quote')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" name="news_details" id="news_details" >{{ old('news_details') }}</textarea>
                            @error('news_details')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
