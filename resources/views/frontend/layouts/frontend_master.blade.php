                ...
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2">
                        ...
                        <li class="nav-item">
                            ...
                            @else
                            <a class="nav-link text-body small text-light" href="{{ route('login') }}">Register or Login</a>
                            @endauth
                        </li>
                    </ul>
                </nav>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="{{ route('today.news') }}" class="nav-item nav-link {{(Route::currentRouteName() ==  'today.news') ? 'active' : ''}}">Today</a>
    ...
    <div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
        <div class="row py-4">
            <div class="col-lg-4 col-md-6 mb-5 pl-5">
                <h5 class="mb-4 text-white text-uppercase font-weight-bold">About</h5>
                <img src="{{ asset('uploads/default_photo') }}/{{ $default_setting->logo_photo }}" alt="">
                <p class="mt-4">{!! App\Models\About_us::first()->short_description !!}</p>
            </div>
            <div class="col-lg-4 col-md-6 mb-5">
                <h5 class="mb-4 text-white text-uppercase font-weight-bold">Important Link</h5>
                <div class="important_link d-flex">
                    <ul class="mr-5">
                        <li><a href="{{ route('all.category') }}">All Category</a></li>
                        <li><a href="{{ route('all.tag') }}">All Tag</a></li>
                        <li><a href="{{ route('all.news') }}">All News</a></li>
                        <li><a href="{{ route('all.gallery.photo') }}">All Gallery Photo</a></li>
                        <li><a href="{{ route('all.gallery.video') }}">All Gallery Video</a></li>
                        <li><a href="{{ route('about.us') }}">About Us</a></li>
                        <li><a href="{{ route('contact.us') }}">Contact Us</a></li>
                    </ul>
                    <ul>
                        @foreach (App\Models\Page_setting::where('status', 'Active')->get() as $page)
