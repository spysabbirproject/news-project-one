                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            ...
                            <a class="text-secondary font-weight-medium text-decoration-none" href="{{ route('all.news') }}">View All</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-3">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Location Wise News</h4>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">Photo Galery</h4>
                        </div>
                    </div>
                    <div class="col-lg-12">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">Video Galery</h4>
                        </div>
                    </div>
                    <div class="col-lg-12">
