            ...
            <div class="col-lg-8">
                <div class="mb-3">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Short Description</h4>
                    </div>
                ...
                <div class="mb-3">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Long Description</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                ...
                <div class="mb-3">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Our Vision</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        {!! $about_us->our_vision !!}
                    </div>
                ...
                <div class="mb-3">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Our Mission</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
